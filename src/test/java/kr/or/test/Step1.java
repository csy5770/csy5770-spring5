...
public class Step1 extends Object {
	public void Step1() {//클래스 명과 같은 이름의 메서드를 생성자 메서드라 함. 자동으로 만들어짐.
		//자동으로 만들어 집니다.
	...
	//멤버변수(전역변수)는 Step1 클래스에 영향을 모두 주는 변수
	...
	public static void main(String[] args) {
		...
		printMember(names, ages, phoneNums);//장점: 메서드 1번 호출에 3명이 모두 출력
		//메서드 명이 같습니다. 단,메서드에 로드 된 파라미터가 다른 메서드를 호출 = 오버로드
	}
	...
	private static void printMember(String name, int age, String phoneNum) {
		...
		// println 메서드는 출력 후 줄 바꿈 명령실행 println= print + new line
