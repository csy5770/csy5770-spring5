...
#### 20210601(화) 작업.
- 4장 패키지와 예외처리 실습.
- VS code로 작업한 html을 이클립스에 배치(프런트개발자 작업결과를 백엔드 개발자에게 전달받아 배치함.)
- 일괄바꾸기 1. "/home -> "/resouces/home
- 일괄바꾸기 2. '/home -> '/resouces/home
- resources 폴더에 static 콘텐츠(html,css,js,font) 배치.
