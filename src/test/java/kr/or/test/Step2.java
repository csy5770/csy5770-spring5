package kr.or.test;
/*
 * 이 클래스는 메서드 기반의 Step1 클래스를 객체 기반의 클래스로 변경한 클래스
 * @author csy5770
 * 
 * */
class MemberVO{
	//이 클래스는 회원 정보를 저장하는 클래스(자료) 입니다.
	private String name;
	private int age;
	private String phoneNum;
	//하나씩 출력하기 힘들 때 자동으로 멤버변수 값을 출력하는 명령 toString 생성
	@Override
	public String toString() {
		return "MemberVO [name=" + name + ", age=" + age + ", phoneNum=" + phoneNum + "]";
	}
	
	//위 프라이빗 멤버변수를 입출력을 구현하는 메서드를 만듭니다.
	...
	// void한(반환 값이 없는) 입력하는 셋 메서드 입니다.(아래)
	public void setPhoneNum(String phoneNum) {
		this.phoneNum = phoneNum;//프라이빗 변수를 직접 접근 못하니까
		//퍼블릭 메서드로 입력하게 만든 구조
	}
