...
public class AdminController {
	...
	@Inject
	private IF_BoardService boardService;//DI로 스프링빈으로 주입해서 객체로 생성
	...
	public String board_list(@ModelAttribute("pageVO")PageVO pageVO, Model model) throws Exception {
		...
		pageVO.setPerPageNum(5);//UI 하단에서 보여줄 페이징 번호 크기
		pageVO.setQueryPerPageNum(5);//토탈 카운트를 구하기 전 2개의 값이 필수로 필요
